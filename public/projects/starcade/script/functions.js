"use strict";
// Kolla upp om denna länk fungerar jämt, commonspace fungerar iaf.
if (window.location.pathname == "/projects/starcade/index.php") {
    var databaseLink = "\php/assets/api.php";
} else {
    var databaseLink = "\assets/api.php";
}
